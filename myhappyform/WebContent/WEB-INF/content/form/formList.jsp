...
$(function(){
	...
	generic.ShowForm(bigData, '${ctx}' , '' , orgGuid_);
	if(bigData.childResult[0]!=undefined){
		generic.childBindingDB({tableName_:bigData.childResult[0].dataForm.tableName, tableGuid_:dataGuid}, bigData.childResult[0]);
	}
