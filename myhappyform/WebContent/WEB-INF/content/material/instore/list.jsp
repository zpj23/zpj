...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 物资统计 <span class="c-gray en">&gt;</span> 入库统计<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="pd-20">
...
<!-- 			</select> -->
<!-- 		</span> -->
		<button type="button"  class="btn btn-success" onclick="searchInfo();" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜入库</button>
	</div>
...
<iframe id="list_iframe" name="list_frame" src="jlInStoreAction_toiframe" width="100%" height="80%" frameborder="0"></iframe>
</div>
