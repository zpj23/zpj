	   ...
	   $.ajax({
	     ...
	     success: function(data1){
	      ...
	      $("#departmentid").html(str);
           $("#departmentid").val("${maintain.departmentid}");
	     }
	});
}
//初始化物资
function initGoodsInfo(){
 ...
 function initGoods(){
    ...
    $("#goodsid").html(str);
    $("#goodsid").val("${maintain.goodsid}");
    var goodsid="${maintain.goodsid}";
    for(var i=0;i<storeArr.length;i++){
   ...
   function initmain(){
	   $.ajax({
		   ...
		   success: function(data1){
			  ...
			  $("#maintainid").html(str);
        $("#maintainid").val("${maintain.maintainid}");
        $("#damagestate").val("${maintain.damagestate}");
		   }
	});
   }
	 ...
	 function sub(state){
	  $.ajax({
	    type: "POST",
	     url: "jlMaintainAction_doExamineMaintain",
	     async:false,
	     data:"state="+state+"&id="+$("#id").val(),
	     success: function(data1){
	    	 if(data1){
...
<!-- <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 物资信息 <span class="c-gray en">&gt;</span> 报损维修登记<a class="btn btn-success radius r mr-20" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a> -->
<!-- </nav> -->
  ...
  <form action="jlMaintainAction_saveMaintain" name="form1" method="post" class="form form-horizontal" id="form1">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <select  id="goodsid" name="maintain.goodsid" value="${maintain.goodsid}" class="select" datatype="*" nullmsg="请选择物资！" readonly="readonly" >
    	</select>
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="hidden" class="input-text" value="${maintain.supplierid}" name="maintain.supplierid" id="supplierid" >
     ...
     <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${maintain.num}" placeholder="" id="num" name="maintain.num"  datatype="n" nullmsg="请填写数量！" readonly="readonly">
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-3"> <span class="select-box">
        <select class="select" size="1" name="maintain.departmentid" id="departmentid" value="" onchange="" datatype="*" nullmsg="请选择所属部门！" readonly="readonly">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${maintain.chargename}" placeholder="" id="chargename" name="maintain.chargename" readonly="readonly"  datatype="*" nullmsg="请填写申请人！" >
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl">
      ...
      <div class="formControls col-3"> <span class="select-box">
        <select class="select" size="1" name="maintain.damagestate" id="damagestate" value="" onchange="" datatype="*" nullmsg="请选择一项！" readonly="readonly">
    ...
    <div class="row cl" id="wxs" >
      <label class="form-label col-3">维修商名称：</label>
      <div class="formControls col-5">
       <select  id="maintainid" name="maintain.maintainid" class="select"  readonly="readonly"  >
    	</select>
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl" id="wxfy" >
      <label class="form-label col-3"><span class="c-red"></span>合计维修金额：</label>
      <div class="formControls col-5">
        <input type="text" class="input-text" value="${maintain.price}" placeholder="" id="price" name="maintain.price" readonly="readonly"  >
      </div>
      <div class="col-4"> </div>
    </div>
     <div class="row cl" id="bz" >
      <label class="form-label col-3">备注：</label>
      <div class="formControls col-5">
        <textarea name="maintain.remark" id="remark" value="" cols="" rows="" readonly="readonly" class="textarea"  placeholder="说明" datatype="*0-100" dragonfly="true" nullmsg="" onKeyUp="textarealength(this,100)">${maintain.remark}</textarea>
    ...
    <div class="row cl">
      <div class="col-6 col-offset-3">
        <input class="btn btn-primary radius" onclick="save()"  value="&nbsp;&nbsp;审核通过&nbsp;&nbsp;">
         <input class="btn btn-primary radius" onclick="unsave()"  value="&nbsp;&nbsp;审核不通过&nbsp;&nbsp;">
      </div>
    </div>
  </form>
</div>
