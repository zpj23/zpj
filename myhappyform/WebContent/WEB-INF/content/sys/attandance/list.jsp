...
<form action="" name="form1" method="post"  id="form1">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20">
	 <span class="l">
	 	<a style="display:none;" href="javascript:;" onclick="dataTotalInfo()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>考勤汇总信息</a> 
	 	<a style="display:none;" href="javascript:;" onclick="dataAbnormalInfo()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i>考勤异常信息</a>
...
<iframe id="list_iframe" name="list_frame" src="jlAttendanceInfoAction_toiframe" width="100%" height="75%" frameborder="0"></iframe>
</div>
