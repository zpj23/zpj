...
function initTree(){
	$("#tt").tree({
		url:'jlMenuInfoAction_showChildNode',
		
		onBeforeExpand:function(node,param){  
	        $('#tt').tree('options').url = "jlMenuInfoAction_showChildNode?id=" + node.id;
	    },  
		animate: true,
...
function toEdit(pnode,cnode){
	...
	document.getElementById("detail_frame").src="jlMenuInfoAction_toAdd?id="+cpk+"&pid="+ppk;
// 	alert(2);
// 	detail_frame.src="jlDepartmentInfoAction_toAdd?id="+cpk+"&pid="+ppk;
}
function toShowPic(str){
	detail_frame.toShowPic(str);
}
//打开选择人员列表界面
