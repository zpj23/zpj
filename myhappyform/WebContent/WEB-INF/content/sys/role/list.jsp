...
<form action="" name="form1" method="post"  id="form1" enctype="multipart/form-data" >
	...
	<div class="text-c"> 日期范围：
		...
		<input type="text" class="input-text" style="width:250px" placeholder="输入角色名" id="username" name="username">
		<button type="button"  class="btn btn-success" onclick="searchInfo();" id="" name=""><i class="Hui-iconfont">&#xe665;</i> 搜角色</button>
	</div>
...
<!-- 	 <input type="file" id="file" name="file" style="width:150px;" /> -->
	<!--  <a href="javascript:;" onclick="dataimport()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe600;</i>批量导入</a> -->
	  <a href="javascript:;" style="color: white" onclick="admin_add('添加角色','jlRoleInfoAction_toAdd','800','650')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a></span> <!-- <span class="r">共有数据：<strong>${count}</strong> 条</span> -->
	</div>

	</form>
		
<iframe id="list_iframe" name="list_frame" src="jlRoleInfoAction_toiframe" width="100%" height="75%" frameborder="0"></iframe>
</div>
