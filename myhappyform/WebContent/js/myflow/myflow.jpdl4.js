...
$.extend(true,myflow.config.tools.states,{
			startEvent : {
				...
				name : {text:'<<start>>'},
				text : {text:'开始'},
				img : {src : '/Core/images/designer/48/start_event_empty.png',width : 48, height:48},
			...
			endEvent : {
				...
				name : {text:'<<end>>'},
				text : {text:'结束'},
				img : {src : 'images/designer/48/end_event_terminate.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-cancel' : {
				...
				text : {text:'取消'},
				img : {src : 'images/designer/48/end_event_cancel.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			'end-error' : {
				...
				name : {text:'<<end-error>>'},
				text : {text:'错误'},
				img : {src : 'images/designer/48/end_event_error.png',width : 48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			state : {
				...
				name : {text:'<<state>>'},
				text : {text:'状态'},
				img : {src : 'images/designer/48/task_empty.png',width : 48, height:48},
				props : {
			...
			fork : {
				...
				name : {text:'<<fork>>'},
				text : {text:'分支'},
				img : {src : 'images/designer/48/gateway_parallel.png',width :48, height:48},
				attr : {width:50 ,heigth:50 },
				props : {
			...
			scriptTask : {
				...
				name : {text:''},
				text : {text:'脚本任务'},
				img : {src : 'images/designer/16/scriptTask_empty.png',width :16, height:16},
				link : 'props/ScriptTask.html',
				props : 
				{
			...
			msgTask : {
				...
				name : {text:''},
				text : {text:'消息任务'},
				img : {src : 'images/designer/16/msgTask_empty.png',width :16, height:16},
				link : 'props/MsgTask.html',
				props : 
				{
			...
			serviceTask : {
				...
				name : {text:''},
				text : {text:'服务任务'},
				img : {src : 'images/designer/16/serviceTask_empty.png',width :16, height:16},
				link : 'props/ServiceTask.html',
				props : 
				{
