...
(function ($) {
    ...
    $.msgbox = function (opts) {
        ...
        opts.height = opts.height != null ? opts.height : 100;
        // title
    ...
    **/
    $.msgbox.autoclose = {
        ...
        domready: function () {
            ...
            var _this = this;
            this.closeMsg = ''; //&nbsp; &nbsp;关闭<strong>{seconds}</strong>s
            var interval = null;
        ...
        domready: function () {
            ...
            switch (this.opts.type) {
                case 'alert':
                    ...
                    var center = $('<center />').css('padding', '2px').append(closebutton);
                ...
                case 'confirm':
                    ...
                    var center = $('<center />').css('padding', '2px').append(yesbutton).append('&nbsp;').append(nobutton);
                    this.mainWrap.append(center);
                ...
                case 'input':
                    ...
                    var div = $('<div />').css('padding', '2px').append(inputbox).append('&nbsp;').append(okbutton);
