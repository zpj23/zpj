(function ($) {
    $.fn.flow = function (option) {
        var defaultOptions = {
            ...
            handle: "draw",
            img: {
                right: "/images/flow/right_sword.png",
                up: "/images/flow/right_sword.png"
            },
            hover: function () {
        ...
        return this.each(function () {
            ...
            var drawLine = function (start, end) {
                ...
                var x1 = start.offset().left - offsetLeft + opts.padding + opts.width + 2; /*起点位置调整2px*/
                var x2 = start.offset().top - offsetTop + opts.padding + opts.height;
                var y1 = end.offset().left - offsetLeft - 5; /*箭头位置调整5px*/
