...
public class ClientTool {
	private static final Log log = LogFactory.getLog(ClientTool.class);
	public static ClientTool ct=null;
...
//	        params.setMaxTotalConnections(256);//very important!! 
	...
	public static void closeHttp(HttpEntity entity) throws IOException{
		 EntityUtils.consume(entity);
	}
	public static void closeHttp(CloseableHttpResponse response, HttpEntity entity) throws IOException{
	   EntityUtils.consume(entity);
       response.close();
	}
	
	public static void closeHttp(CloseableHttpResponse response) throws IOException{
      response.close();
	}
